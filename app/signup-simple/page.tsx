...
export default function SimpleSignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Skip profile creation for testing
      router.push("/welcome")
    } catch (err: any) {
  ...
  return (
    <div className="flex flex-col min-h-screen px-6 bg-[#1E1E1E] text-white">
      ...
      <div className="flex flex-col items-center mt-12">
        ...
        {/* Sign Up Heading */}
        <h1 className="text-[32px] font-normal mt-6">Simple Sign Up</h1>
        <p className="text-sm text-gray-400 mt-2">(Skips profile creation)</p>
      </div>
