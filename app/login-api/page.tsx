  ...
  return (
    <div className="flex flex-col min-h-screen px-6 bg-[#1E1E1E] text-white">
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-4">
        ...
        <Button type="submit" className="w-full py-3.5 text-base" size="lg" disabled={loading}>
        ...
        <div className="text-center mt-4">
          <p className="text-gray-400">
            ...
            <Link href="/signup-direct" className="text-[#007BFF] hover:text-[#F6861F] transition-colors duration-150">
              Sign up
            </Link>
          </p>
        </div>
