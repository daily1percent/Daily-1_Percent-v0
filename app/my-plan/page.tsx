  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#1E1E1E] text-white pb-16">
      ...
      <div className="px-6 pt-8">
        ...
        <h1 className="text-2xl font-medium mt-6">My Plan</h1>
        <p className="text-gray-400 text-sm mt-1">Your training schedule</p>
      </div>

      {/* Content Placeholder */}
      <div className="flex-1 flex items-center justify-center px-6">
        <p className="text-gray-400">My Plan content will go here</p>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#2A2A2A] border-t border-[#3A3A3A] h-16 flex items-center justify-around">
        ...
        <Link href="/my-plan" className="flex flex-col items-center text-white">
